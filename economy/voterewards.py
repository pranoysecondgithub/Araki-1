...
class VoteRewards(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if message.channel.id == 952278017571442750:
            ...
            embed = nextcord.Embed(title="Thanks for voting!",
                                   description=f"You can vote in every 12hr!",
                                   colour=clr)
            ...
            if find is None:
                ...
                embed.add_field(
                    name="Arency",
                    value="1000 Arency added to your wallet for voting!")
            ...
            if inv_find is None:
                ...
                embed.add_field(
                    name='Inventory',
                    value='1x Fish added to your inventory for voting!')
