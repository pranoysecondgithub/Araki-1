...
from Utility.delbtn import DelBtn as MessageDelete
import spotipy
...
#         options = [
#             nextcord.SelectOption(label='Red', description='Your favourite colour is red'),
#             nextcord.SelectOption(label='Green', description='Your favourite colour is green'),
#             nextcord.SelectOption(label='Blue', description='Your favourite colour is blue')
#         ]
