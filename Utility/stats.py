...
class Stats(commands.Cog):
    ...
    async def Stats(self, ctx):
        ...
        embed.add_field(name="Stats", value=f'Devloper :- [Pranoy#0140](https://discord.com/users/942683245106065448)\nTeam Members :- [Adarsh](https://discord.com/users/609358846585995264), [Pritam](https://discord.com/users/595549200796745728), [Akshat](https://discord.com/users/921356594699182090), [Spidey](https://discord.com/users/715447259700920352), [Lucifer](https://discord.com/users/909777615592767499)\nBot Uptime :- {days}d, {hours}h, {minutes}m, {seconds}s\nMemory Usage :- {psutil.virtual_memory().percent}%\nCPU Usage :- {psutil.cpu_percent()}%\nTotal Servers :- {len(pranoy.guilds)}\nTotal Users :- {len(pranoy.users)}')
